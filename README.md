...
[![Tests](https://img.shields.io/badge/Tests-129%20Passing-brightgreen.svg)](./TESTS.md)
...
```bash
# 1. Execute full JavaScript engine, UI, Candidate Lines & Visual Regression battery (69 tests)
$ npm test
...
* **Test Catalog:** For a detailed breakdown of all 129 individual test cases, engineering rationales, and pipeline locations, consult [`TESTS.md`](./TESTS.md).
