...
Located in [`tests/unit/`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/), these tests run during **Stage 2** of CI and validate core simulation primitives in isolation without disk or network I/O.

### 2.1 [`test_state.py`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_state.py)

#### 1. `test_default_setup_invariants`
- **Location**: [`tests/unit/test_state.py:6`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_state.py#L6)
...
- **Location**: [`tests/unit/test_state.py:21`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_state.py#L21)
- **Stage**: Unit Testing (Python)
...
- **Location**: [`tests/unit/test_state.py:31`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_state.py#L31)
- **Stage**: Unit Testing (Python)
...
- **Location**: [`tests/unit/test_state.py:40`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_state.py#L40)
- **Stage**: Unit Testing (Python)
...
- **Location**: [`tests/unit/test_state.py:54`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_state.py#L54)
- **Stage**: Unit Testing (Python)
...
### 2.2 [`test_updater.py`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_updater.py)

#### 6. `test_action_dispatch_table`
- **Location**: [`tests/unit/test_updater.py:7`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_updater.py#L7)
- **Stage**: Unit Testing (Python)
...
- **Location**: [`tests/unit/test_updater.py:19`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_updater.py#L19)
- **Stage**: Unit Testing (Python)
...
- **Location**: [`tests/unit/test_updater.py:35`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_updater.py#L35)
- **Stage**: Unit Testing (Python)
...
### 2.3 [`test_mcts.py`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_mcts.py)

#### 9. `test_opening_book_loading_and_lookup`
- **Location**: [`tests/unit/test_mcts.py:7`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/unit/test_mcts.py#L7)
- **Stage**: Unit Testing (Python)
- **What it is**: Instantiates `OpeningBook()`, verifies that it loads non-zero opening lines from [`public/opening_book.json`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/public/opening_book.json), and queries the default state to confirm the move return type is an integer within `[0, 959)`.
...
Located in [`tests/js/engine.test.js`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js), these tests run in **Stage 2** using native `node:test` and assert client-side engine compliance.

#### 10. `GameState default setup invariants`
- **Location**: [`tests/js/engine.test.js:9`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L9)
...
- **Location**: [`tests/js/engine.test.js:23`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L23)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:35`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L35)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:48`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L48)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:60`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L60)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:68`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L68)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:87`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L87)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:99`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L99)
- **Stage**: Unit Testing (Node.js)
...
- **Location**: [`tests/js/engine.test.js:117`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/engine.test.js#L117)
- **Stage**: Unit Testing (Node.js)
...
Located in [`tests/js/ui.test.js`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js), this suite tests DOM hierarchy, viewport responsiveness, CSS `@media` rules, accessibility attributes, and PWA specs.

#### 19. `HTML Template - Essential Viewport, PWA & Meta Tags`
- **Location**: [`tests/js/ui.test.js:15`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L15)
- **Stage**: Frontend Testing (Node.js)
- **What it is**: Inspects [`public/index.html`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/public/index.html) for `viewport` meta (`width=device-width`), `theme-color` meta (`#d4a359`), manifest linkage, and title tag.
...
- **Location**: [`tests/js/ui.test.js:25`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L25)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:46`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L46)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:63`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L63)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:101`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L101)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:111`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L111)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:132`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L132)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:188`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L188)
- **Stage**: Frontend Testing (Node.js)
- **What it is**: Parses [`public/style.css`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/public/style.css) to verify the existence of all 5 responsive breakpoints (`@media (max-width: 767px)`, `@media (min-width: 768px)...`, `@media (min-width: 1024px)...`, `@media (min-width: 1400px)`, `@media (max-width: 900px)`).
...
- **Location**: [`tests/js/ui.test.js:208`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L208)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:233`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L233)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:250`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L250)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:268`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L268)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:278`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L278)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:294`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L294)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:301`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L301)
- **Stage**: Frontend Testing (Node.js)
- **What it is**: Parses [`public/manifest.json`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/public/manifest.json) and verifies name, short_name, display mode (`standalone`), start URL (`./index.html`), background/theme colors, and icon formats.
...
- **Location**: [`tests/js/ui.test.js:313`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L313)
- **Stage**: Frontend Testing (Node.js)
- **What it is**: Verifies [`public/sw.js`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/public/sw.js) implements `install`, `activate`, and `fetch` event listeners, and caches essential assets (`index.html`, `style.css`, `script.js`, `themes.js`, `opening_book.json`).
...
- **Location**: [`tests/js/ui.test.js:327`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L327)
- **Stage**: Frontend Testing (Node.js)
...
- **Location**: [`tests/js/ui.test.js:347`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/js/ui.test.js#L347)
- **Stage**: Frontend Testing (Node.js)
...
Located in [`tests/integration/`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/), these tests run during **Stage 3** and test end-to-end interactions, multi-step game progression, REST APIs, and cross-runtime parity.

### 5.1 [`test_parity.py`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_parity.py)

#### 37. `test_default_state_string_parity`
- **Location**: [`tests/integration/test_parity.py:8`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_parity.py#L8)
...
- **Location**: [`tests/integration/test_parity.py:25`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_parity.py#L25)
- **Stage**: Integration Testing (Cross-Engine)
...
### 5.2 [`test_api.py`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py)

#### 39. `test_api_init`
- **Location**: [`tests/integration/test_api.py:50`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L50)
...
- **Location**: [`tests/integration/test_api.py:59`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L59)
- **Stage**: Integration Testing (FastAPI)
...
- **Location**: [`tests/integration/test_api.py:66`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L66)
- **Stage**: Integration Testing (FastAPI)
...
- **Location**: [`tests/integration/test_api.py:71`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L71)
- **Stage**: Integration Testing (FastAPI)
...
- **Location**: [`tests/integration/test_api.py:82`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L82)
- **Stage**: Integration Testing (FastAPI)
...
- **Location**: [`tests/integration/test_api.py:92`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L92)
- **Stage**: Integration Testing (FastAPI)
...
#### 45. `test_api_play_ai`
- **Location**: [`tests/integration/test_api.py:100`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L100)
- **Stage**: Integration Testing (FastAPI)
...
- **Location**: [`tests/integration/test_api.py:113`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_api.py#L113)
- **Stage**: Integration Testing (FastAPI)
...
### 5.3 [`test_gameplay.py`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_gameplay.py)

#### 47. `test_multistep_gameplay_flow`
- **Location**: [`tests/integration/test_gameplay.py:9`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_gameplay.py#L9)
...
- **Location**: [`tests/integration/test_gameplay.py:40`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_gameplay.py#L40)
- **Stage**: Integration Testing (Simulation)
...
- **Location**: [`tests/integration/test_gameplay.py:67`](file:///Users/kshitij.tomar/Desktop/Berkeley/TigersDay/tests/integration/test_gameplay.py#L67)
- **Stage**: Integration Testing (Simulation)
